...
.controller('NavBarCtrl', function ($scope, $state, apiService) {
...
.controller('MainViewCtrl', function ($scope, $stateParams, apiService, reviewService) {
...
.controller('RateClassCtrl', function ($scope, $state, $stateParams, reviewService) {
    var scope = $scope;
    $scope.profId = $stateParams.profId;
    $scope.reviewMax = reviewService.reviewMax;
...
.controller('AddProfessorCtrl', function ($scope, $state, apiService) {
    $scope.professor = {};
